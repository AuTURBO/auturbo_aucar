#ifndef _ROS_SERVICE_ThreeInts_h
#define _ROS_SERVICE_ThreeInts_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char THREEINTS[] = "roscpp_tutorials/ThreeInts";

  class ThreeIntsRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return THREEINTS; };
    const char * getMD5(){ return "c8559b52d432bccd240703f31aeca517"; };

  };

  class ThreeIntsResponse : public ros::Msg
  {
    public:
